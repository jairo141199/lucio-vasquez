    ...
    <svg viewBox="0 0 200 200" className={className} fill="none">
      <defs>
        <linearGradient id="portrait-bg" x1="0" y1="0" x2="200" y2="200">
          ...
          <stop offset="100%" stopColor="#0B2818" />
        </linearGradient>
      </defs>
    ...
    <svg viewBox="0 0 80 80" className={className} fill="none">
      <defs>
        <radialGradient id="crystal-ball-lv" cx="35%" cy="30%" r="70%">
          ...
          <stop offset="55%" stopColor="#3FAE7C" />
          <stop offset="100%" stopColor="#0F4A31" />
        </radialGradient>
      </defs>
...
export function TarotCard({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 60 90" className={className} fill="none">
      <rect x="2" y="2" width="56" height="86" rx="6" fill="#123B29" stroke="#D4AF37" strokeWidth="1.5" />
...
export function Candle({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 80" className={className} fill="none">
      ...
      <rect x="10" y="24" width="20" height="50" rx="2" fill="#F3EFE0" opacity="0.9" />
...
export function LuckyCoins({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none">
      <ellipse cx="40" cy="60" rx="26" ry="8" fill="#0F4A31" stroke="#D4AF37" strokeWidth="1.5" />
      <ellipse cx="40" cy="50" rx="26" ry="8" fill="#1C6B4A" stroke="#D4AF37" strokeWidth="1.5" />
      <ellipse cx="40" cy="40" rx="26" ry="8" fill="#2F9E60" stroke="#D4AF37" strokeWidth="1.5" />
      <ellipse cx="40" cy="30" rx="26" ry="8" fill="#D4AF37" />
      <text x="40" y="34" textAnchor="middle" fontSize="10" fill="#0B2818" fontWeight="bold">
        $
      </text>
    </svg>
  );
