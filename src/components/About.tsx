...
export function About() {
  return (
    <section id="nosotros" className="mx-auto max-w-4xl px-5 py-20 text-center sm:px-8">
      ...
      <h2 className="mt-3 font-serif text-3xl text-[#F3EFE0] sm:text-4xl">Aprendiz y mano derecha de Mhoni Vidente</h2>
      <p className="mx-auto mt-6 max-w-2xl text-[15px] leading-relaxed text-[#F3EFE0]/70">
