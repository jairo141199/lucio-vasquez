...
export function ContactCTA() {
  ...
  return (
    <section id="contacto" className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
      <div className="relative overflow-hidden rounded-3xl border border-[#D4AF37]/20 bg-[#24113D] px-8 py-16 text-center">
        <div
          aria-hidden
        ...
        <div className="relative">
          ...
          <h2 className="mx-auto mt-3 max-w-xl font-serif text-3xl text-[#F4EBDD] sm:text-4xl">
            Agenda tu cita y deja que la buena energía te acompañe
          </h2>
          <p className="mx-auto mt-4 flex max-w-md items-center justify-center gap-1.5 text-[15px] text-[#F4EBDD]/70">
          ...
          <button
            type="button"
            onClick={copyNumber}
            className="mx-auto mt-5 flex items-center gap-1.5 text-sm text-[#F4EBDD]/60 transition-colors hover:text-[#F4EBDD]"
          >
